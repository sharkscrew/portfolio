  ...
  return (
    <div className="min-h-screen pt-28 pb-20 px-6">
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        <div
          className="absolute -bottom-40 left-1/2 w-96 h-96 rounded-full blur-3xl"
        ...
        <div className="flex flex-col gap-3">
          {contacts.map((c) => (
            <a
              ...
              className="group flex items-center gap-5 p-5 rounded-xl transition-all duration-300 hover:scale-[1.01]"
              style={{
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs mb-0.5 text-white/30">{c.label}</p>
                <p className="text-sm font-medium text-white/70 group-hover:text-white transition-colors truncate group-hover:underline decoration-1 underline-offset-4"
                   style={{ textDecorationColor: accentColor }}>
                  {c.value}
                </p>
              </div>
              <svg
                className="shrink-0 opacity-0 group-hover:opacity-100 transition-all duration-300 -translate-x-2 group-hover:translate-x-0"
                width="16"
                height="16"
                fill="none"
                stroke="currentColor"
